...
const SUPERVISORS = [
  {
    ...
    photo: "/assets/team/supervisor.jpg",
    linkedin: "#",
  },
  {
    id: "cosupervisor",
    ...
    photo: "/assets/team/cosupervisor.jpg",
    linkedin: "#",
  },
];
...
const MEMBERS = [
  ...
  },
  {
    ...
    role: "Team Member",
    studentId: "IT21XXXXXX",
    component: "IaC Generation & Repository Analysis",
  ...
  },
  {
    ...
    role: "Team Member",
    studentId: "IT21XXXXXX",
    component: "Adaptive Test Case Prioritization",
  ...
  },
  {
    ...
    role: "Team Member",
    studentId: "IT21XXXXXX",
    component: "Chaos & Resilience Validation Agent",
...
function PhotoPlaceholder({ name, size = 80 }: { name: string; size?: number }) {
  const initials = name
    .split(" ")
    .map((n) => n[0])
    .join("")
  ...
  return (
    <div
      ...
      style={{
        width: size,
        height: size,
        background: "linear-gradient(135deg, rgba(34,211,238,0.2), rgba(251,191,36,0.15))",
              ...
              >
                <div className="relative">
                  ...
                  <div style={{ display: "none" }}>
                    <PhotoPlaceholder name={sup.name} size={72} />
                  </div>
                </div>
            ...
            {MEMBERS.map((member) => (
              ...
              >
                ...
                <div className="relative mb-4">
                  ...
                  />
                  <PhotoPlaceholder name={member.name} size={84} />
                </div>
                ...
                <span
                  ...
                  style={{
                    background: member.role === "Team Leader" ? "rgba(34,211,238,0.1)" : "rgba(100,100,100,0.1)",
                    color: member.role === "Team Leader" ? "var(--accent-cyan)" : "var(--text-muted)",
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: "var(--text-secondary)", fontFamily: "var(--font-sans)" }}>
              Faculty of Computing · Department of Information Technology · Final Year Research Project 2024/2025
            </p>
          </div>
        </div>
      </div>
