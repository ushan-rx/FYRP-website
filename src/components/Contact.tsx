...
import { Mail, MessageSquare, Send, CheckCircle, Github, Globe } from "lucide-react";
...
export default function Contact() {
  ...
  const handleSubmit = (e: React.MouseEvent) => {
    ...
    const mailtoLink = `mailto:synapseci@example.com?subject=Enquiry from ${encodeURIComponent(form.name)}&body=${encodeURIComponent(form.message)}%0A%0AFrom: ${encodeURIComponent(form.email)}`;
              ...
              {[
                {
                  ...
                  value: "synapseci@example.com", // Replace with actual email
            ...
            {submitted ? (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  {error && (
                    <p className="font-mono text-xs" style={{ color: "#fb7185" }}>
                      ⚠ {error}
                    </p>
                  )}
