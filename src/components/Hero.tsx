...
const TERMINAL_LINES = [
  { prefix: "$ ", text: "synapse-ci init --repo my-microservice", color: "var(--accent-cyan)" },
  { prefix: "  ✓ ", text: "Repository analyzed. Tech: [Node.js, Docker, K8s]", color: "var(--text-secondary)" },
  { prefix: "  ✓ ", text: "Catalog match found (similarity: 0.94)", color: "#4ade80" },
  { prefix: "  ⚙ ", text: "Intent: feature_deploy · Risk: LOW", color: "var(--accent-amber)" },
  { prefix: "  ✓ ", text: "Policy Guardian: APPROVED (2 gates passed)", color: "#4ade80" },
  { prefix: "  ✓ ", text: "Generating YAML + ADR audit trail...", color: "var(--text-secondary)" },
  { prefix: "  ✓ ", text: "Workflow committed to .github/workflows/", color: "#4ade80" },
  { prefix: "  → ", text: "Tests prioritized · Resilience score: 87/100", color: "var(--accent-cyan)" },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(to bottom, transparent, var(--accent-cyan), transparent)", left: "10%" }}
      />
      <div
        className="absolute top-0 right-0 w-px h-full opacity-20"
        style={{ background: "linear-gradient(to bottom, transparent, var(--accent-amber), transparent)", right: "10%" }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="badge">Research Project · SLIIT 2025</span>
              <span
            ...
            >
              ...
              <strong style={{ color: "var(--accent-cyan)" }}>Human-in-the-Loop CI/CD orchestration</strong>,
              governed knowledge management, IaC generation, adaptive test prioritization, and
              automated chaos validation — all under one connected lifecycle.
            </p>
                ...
                {visibleLines < TERMINAL_LINES.length && (
                  <div className="font-mono text-sm" style={{ color: "var(--accent-cyan)" }}>
                    ...
                    <span
                      ...
                      style={{
                        background: cursor ? "var(--accent-cyan)" : "transparent",
              ...
              >
                ...
                >
                  ...
                  <span style={{ color: "var(--accent-cyan)" }}>
                    {Math.round((visibleLines / TERMINAL_LINES.length) * 100)}%
                  </span>
                </div>
                <div
