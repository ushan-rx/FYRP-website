    ...
    <section id="milestones" className="section">
      <div className="container-xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {[
            { label: "Total Milestones", value: MILESTONES.length.toString() },
            { label: "Completed", value: `${completed}/${MILESTONES.length}` },
        ...
        <div className="relative pl-8">
          ...
          <div className="space-y-4">
            {filtered.map((milestone, i) => {
              const color = STATUS_COLORS[milestone.status] ?? "var(--text-muted)";
                  ...
                  >
                    <div className="p-5 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          ...
                          <span style={{ color }}>
                            {milestone.marks}% marks allocated
                          </span>
                        </div>
                      </div>
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: milestone.status === "completed" ? "100%" : milestone.status === "active" ? "65%" : "0%",
