...
const PRESENTATIONS = [
  {
    ...
    slides: "#", // Replace with actual link
    status: "available",
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {PRESENTATIONS.map((pres, i) => (
            <div
              ...
              style={{ opacity: pres.status === "pending" ? 0.65 : 1 }}
            >
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <div
                      ...
                      style={{ background: "var(--accent-cyan)", width: "60%" }}
                    />
                    <div
                      className="h-1.5 rounded-sm"
                      style={{ background: "var(--border)", width: "90%" }}
                    />
                    <div
                      className="h-1.5 rounded-sm"
                ...
                <div
                  ...
                  style={{
                    background: pres.status === "available" ? "rgba(74, 222, 128, 0.15)" : "rgba(100,100,100,0.15)",
                    color: pres.status === "available" ? "#4ade80" : "var(--text-muted)",
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <a
                  ...
                  style={{
                    background: pres.status === "available" ? "rgba(34,211,238,0.1)" : "var(--bg-secondary)",
                    color: pres.status === "available" ? "var(--accent-cyan)" : "var(--text-muted)",
                    border: "1px solid var(--border)",
                    pointerEvents: pres.status === "pending" ? "none" : "auto",
                  }}
                >
